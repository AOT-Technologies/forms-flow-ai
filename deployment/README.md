...
Clone the deployments repository from the location [Quick Installation](https://github.com/AOT-Technologies/forms-flow-ai-deployment) and follow the instructions given in the [usage file](https://github.com/AOT-Technologies/forms-flow-ai-deployment/blob/main/scripts/usage.txt).
