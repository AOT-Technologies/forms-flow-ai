...
class TaskSchema(Schema):
    ...
    process_definition_key = fields.Str(data_key='processDefinitionKey',
                                        attribute='processDefinitionKey')
    task_definition_key = fields.Str(data_key='taskDefinitionKey',
                                     attribute='taskDefinitionKey')
