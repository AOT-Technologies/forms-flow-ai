...
class ApplicationService:
    ...
    def get_auth_applications_and_count(page_no, limit, token):
        ...
        auth_form_details = BPMService.get_auth_form_details(
            token = token
        )
        form_ids = []
    ...
    def get_all_applications_ids(application_ids):
        applications = Application.find_by_ids(
    ...
    def get_all_applications_form_id_count(form_id):
        """Get application count."""
        return Application.find_all_by_form_id_count(
            form_id = form_id
        )
    ...
    def get_application(application_id):
        ...
        return ApplicationSchema().dump(Application.find_by_id(
    ...
    def get_application_form_mapper_by_id(application_id):
        ...
        mapper = FormProcessMapper.find_by_application_id(
            application_id = application_id
        )
        if mapper:
