...
class TestConfig(_Config):  # pylint: disable=too-few-public-methods
    ...
    JWT_OIDC_TEST_ISSUER = "http://localhost:1000/auth/realms/forms-flow-ai"  # os.getenv("JWT_OIDC_ISSUER")
    JWT_OIDC_TEST_WELL_KNOWN_CONFIG = "http://localhost:1000/auth/realms/forms-flow-ai/.well-known/openid-configuration"
    ...
    JWT_OIDC_TEST_JWKS_URI = (
        "http://localhost:1000/auth/realms/forms-flow-ai/protocol/openid-connect/certs"
    )
