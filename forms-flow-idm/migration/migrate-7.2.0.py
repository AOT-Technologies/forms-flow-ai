...
import argparse
from utils import get_access_token, get_client_id, add_client_roles, update_client_role, role_changes_710
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Migrate new roles, and updates role descriptions in the multitenant environment")
