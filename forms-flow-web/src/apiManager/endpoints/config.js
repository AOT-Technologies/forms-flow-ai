...
export const BPM_TOKEN_URL =
  window._env_.REACT_APP_BPM_TOKEN_API || process.env.REACT_APP_BPM_TOKEN_API;
...
export const WEB_BASE_URL = `${
  window._env_.REACT_APP_WEB_BASE_URL || process.env.REACT_APP_WEB_BASE_URL
}/`;
