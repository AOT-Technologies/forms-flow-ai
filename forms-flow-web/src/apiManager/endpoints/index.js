...
const API = {
  ...
  GET_BPM_DEPLOYMENTS: `${BPM_BASE_URL}/deployment`,
  GET_BPM_DEPLOYMENT_RESOURCES: `${BPM_BASE_URL}/deployment/<deployment_id>/resources`,
  GET_BPM_DEPLOYMENT_DIAGRAM: `${BPM_BASE_URL}/deployment/<deployment_id>/resources/<resource_id>/data`,
