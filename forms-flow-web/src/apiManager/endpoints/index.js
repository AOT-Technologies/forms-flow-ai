...
import {WEB_BASE_URL, BPM_BASE_URL, MT_ADMIN_BASE_URL, MT_ADMIN_BASE_URL_VERSION, BPM_BASE_URL_EXT, CUSTOM_SUBMISSION_URL} from "./config";
...
const API = {
  ...
  GET_PROCESS_DEFINITION: `${BPM_BASE_URL}/process-definition/key/<process_key>`,
  ...
  GET_BPM_DEPLOYMENTS: `${BPM_BASE_URL_EXT}/deployment`,
  GET_BPM_DEPLOYMENT_RESOURCES: `${BPM_BASE_URL_EXT}/deployment/<deployment_id>/resources`,
  GET_BPM_DEPLOYMENT_DIAGRAM: `${BPM_BASE_URL_EXT}/deployment/<deployment_id>/resources/<resource_id>/data`,
