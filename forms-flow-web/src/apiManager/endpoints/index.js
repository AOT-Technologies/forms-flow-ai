...
const API = {
  ...
  GET_PROCESS_DEFINITION: `${BPM_BASE_URL_EXT}/v1/version/process-definition/key/<process_key>`,
  PROCESSES_XML: `${BPM_BASE_URL_EXT}/v1/version/process-definition/key/<process_key>/xml`,
  DMN_XML: `${BPM_BASE_URL_EXT}/v1/version/decision-definition/key/<process_key>/xml`,
  PROCESS_ACTIVITIES: `${BPM_BASE_URL_EXT}/v1/version/process-instance/<process_instance_id>/activity-instances`,
  ...
  APPLICATION_EVENT_UPDATE: `${BPM_BASE_URL_EXT}/v1/version/message`,
  GET_BPM_TASKS: `${BPM_BASE_URL_EXT}/v1/version/task`,
  GET_BPM_TASK_DETAIL: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>`,
  GET_BPM_TASK_VARIABLES: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/variables`,
  CLAIM_BPM_TASK: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/claim`,
  UNCLAIM_BPM_TASK: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/unclaim`,
  GET_BPM_PROCESS_LIST: `${BPM_BASE_URL_EXT}/v1/version/process-definition`,
  GET_DMN_PROCESS_LIST: `${BPM_BASE_URL_EXT}/v1/version/decision-definition`,
  GET_BPM_USER_LIST: `${BPM_BASE_URL_EXT}/v1/version/user`,
  GET_BPM_FILTERS: `${BPM_BASE_URL_EXT}/v1/version/filter`,
  GET_BPM_TASK_LIST_WITH_FILTER: `${BPM_BASE_URL_EXT}/v1/version/filter/<filter_id>/list`,
  GET_BPM_TASK_LIST_COUNT_WITH_FILTER: `${BPM_BASE_URL_EXT}/v1/version/filter/<filter_id>/count`,
  BPM_GROUP: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/identity-links`,
  DELETE_BPM_GROUP: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/identity-links/delete`,
  BPM_FORM_SUBMIT: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/submit-form`,
  GET_BPM_FORM_LIST: `${WEB_BASE_URL}/form`,
  UPDATE_ASSIGNEE_BPM_TASK: `${BPM_BASE_URL_EXT}/v1/version/task/<task_id>/assignee`,
  ...
  DEPLOY_BPM: `${BPM_BASE_URL_EXT}/v1/version/deployment/create`,
