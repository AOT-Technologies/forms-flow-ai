...
const API = {
  ...
  GET_PROCESS_DEFINITION: `${BPM_API_URL_WITH_VERSION}/process-definition/key/<process_key>`,
  PROCESSES_XML: `${BPM_API_URL_WITH_VERSION}/process-definition/key/<process_key>/xml`,
  GET_PROCESSES_XML: `${WEB_BASE_URL}/process`,
  DMN_XML: `${BPM_API_URL_WITH_VERSION}/decision-definition/key/<process_key>/xml`,
  PROCESS_ACTIVITIES: `${BPM_API_URL_WITH_VERSION}/process-instance/<process_instance_id>/activity-instances`,
  ...
  GET_BPM_TASKS: `${BPM_API_URL_WITH_VERSION}/task`,
  GET_BPM_TASK_DETAIL: `${BPM_API_URL_WITH_VERSION}/task/<task_id>`,
  GET_BPM_TASK_VARIABLES: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/variables`,
  CLAIM_BPM_TASK: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/claim`,
  UNCLAIM_BPM_TASK: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/unclaim`,
  GET_BPM_PROCESS_LIST: `${BPM_API_URL_WITH_VERSION}/process-definition`,
  GET_DMN_PROCESS_LIST: `${BPM_API_URL_WITH_VERSION}/decision-definition`,
  GET_API_USER_LIST: `${WEB_BASE_URL}/user`,
  UPDATE_DEFAULT_FILTER: `${WEB_BASE_URL}/user/default-filter`,
  GET_BPM_FILTERS: `${BPM_API_URL_WITH_VERSION}/filter`,
  GET_BPM_TASK_LIST_WITH_FILTER: `${BPM_API_URL_WITH_VERSION}/filter/<filter_id>/list`,
  GET_BPM_TASK_LIST_COUNT_WITH_FILTER: `${BPM_API_URL_WITH_VERSION}/filter/<filter_id>/count`,
  BPM_GROUP: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/identity-links`,
  DELETE_BPM_GROUP: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/identity-links/delete`,
  BPM_FORM_SUBMIT: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/submit-form`,
  GET_BPM_FORM_LIST: `${WEB_BASE_URL}/form`,
  UPDATE_ASSIGNEE_BPM_TASK: `${BPM_API_URL_WITH_VERSION}/task/<task_id>/assignee`,
  GET_FORM_BY_ALIAS: `${AppConfig.projectUrl}/<form_path>`,
  GET_FORM_BY_ID: `${AppConfig.projectUrl}/form`,
  GET_BPM_PROCESS_LIST_COUNT: `${BPM_API_URL_WITH_VERSION}/process-definition/count`,
  GET_DMN_PROCESS_LIST_COUNT: `${BPM_API_URL_WITH_VERSION}/decision-definition/count`,
  ...
  DEPLOY_BPM: `${BPM_API_URL_WITH_VERSION}/deployment/create`,
  ...
  GET_BPM_TASK_FILTERS : `${BPM_API_URL_WITH_VERSION}/task-filters`,
