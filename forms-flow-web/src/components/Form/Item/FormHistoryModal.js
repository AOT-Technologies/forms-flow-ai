                  ...
                  <li key={index}>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-primary">{history.changeLog.new_version && t(`${history.changeLog.version ? "Version " + history.changeLog.version + " created" : "New version created"}`)}</span>
                      </div>
                      <div>
