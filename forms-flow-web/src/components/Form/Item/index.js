...
import {STAFF_REVIEWER, CLIENT, STAFF_DESIGNER, BASE_ROUTE, MULTITENANCY_ENABLED} from '../../../constants/constants'
...
import {setFormFailureErrorData, setFormRequestData, setFormSuccessData, resetFormData, clearSubmissionError} from "../../../actions/formActions";
  ...
  return (
      <div>
        <Switch>
          ...
          <FormActionRoute path={`${BASE_ROUTE}form/:formId/preview`} component={Preview}/>
          <FormActionRoute path={`${BASE_ROUTE}form/:formId/edit`} component={Edit}/>
          <SubmissionRoute path={`${BASE_ROUTE}form/:formId/submission`} component={Submission}/>
