...
export const ROUTE_TO = {
  DRAFT: BASE_ROUTE + MAIN_ROUTE.DRAFT,
  FORM: BASE_ROUTE + MAIN_ROUTE.FORM,
  FORMFLOW: BASE_ROUTE + MAIN_ROUTE.FORMFLOW,
  TASK: BASE_ROUTE + MAIN_ROUTE.TASK,
  APPLICATION: BASE_ROUTE + MAIN_ROUTE.APPLICATION,
  SUBFLOW: BASE_ROUTE + MAIN_ROUTE.SUBFLOW,
  DECISIONTABLE: BASE_ROUTE + MAIN_ROUTE.DECISIONTABLE,
  METRICS: BASE_ROUTE + MAIN_ROUTE.METRICS,
  INSIGHTS: BASE_ROUTE + MAIN_ROUTE.INSIGHTS,
  ADMIN: BASE_ROUTE + MAIN_ROUTE.ADMIN,
  NOTFOUND: BASE_ROUTE + MAIN_ROUTE.NOTFOUND
};