/**
 * Default BPMN workflow template for new forms
 * This template includes a complete workflow with:
 * - Start Event with async after
 * - Audit Task with execution listeners
 * - End Event
 * - Proper sequence flows
 */

export const createDefaultBpmnXml = () => {
...
<bpmn:definitions
    ...
    <bpmn:process id="Defaultflow" name="Defaultflow" isExecutable="true">
        ...
        <bpmn:sequenceFlow 
            id="Flow_0klorcg" 
            sourceRef="Audit_Task_Executed" 
            targetRef="Event_1ws2h5w" />
    </bpmn:process>
...
export default createDefaultBpmnXml;
