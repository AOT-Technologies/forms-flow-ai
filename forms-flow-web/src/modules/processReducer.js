...
const process = (state = initialState, action) => {
  switch (action.type) {
    ...
    case ACTION_CONSTANTS.FORM_PROCESS_LIST:
      return { ...state, formProcessList: action.payload, workflowAssociated:action.payload?.processKey?{label:action.payload?.processName,value:action.payload?.processKey}:null};
