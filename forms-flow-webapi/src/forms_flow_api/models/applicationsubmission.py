...
class ApplicationSubmission(BaseModel, db.Model):
    """Application Model for storing application submission related details."""
    ...
    FORM_PROCESS_MAPPER = db.relationship(
        'Application',
        primaryjoin='ApplicationSubmission.mapper_id == Application.mapper_id',
